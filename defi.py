...
OUT_XLSX = os.path.join(OUTPUT_DIR, "eventday_defi_timeseries.xlsx")

# === 事件日 defi 幣 IDs ===
coin_ids = [
    "chainlink", "ethena-usde", "bitget-token", "uniswap", "aave",
    "bittensor", "crypto-com-chain", "dai", "ondo-finance", "ethena",
    "render-token", "polygon-ecosystem-token", "sei-network", "fetch-ai", "fasttoken",
    "gatechain-token", "filecoin", "quant-network", "jupiter-exchange-solana", "jupiter-perpetuals-liquidity-provider-token",
    "kucoin-shares", "flare-networks", "injective-protocol", "curve-dao-token", "nexo",
    "lido-dao", "ethereum-name-service", "pancakeswap-token", "vaulta", "syrupusdc",
    "aerodrome-finance", "raydium", "immutable-x", "the-graph", "hyperliquid",
    "virtual-protocol", "sonic-3", "jasmycoin"
]
