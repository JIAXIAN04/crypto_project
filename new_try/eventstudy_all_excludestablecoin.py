...
AAR_CAAR_XLSX = f"{OUTPUT_DIR}/AAR_CAAR_results_2025-07-17_all_no_stablecoins.xlsx"
CHECK_WINDOW_XLSX = f"{OUTPUT_DIR}/AAR_CAAR_check_window_2025-07-17_all_no_stablecoins.xlsx"
...
if ar_all:
    ...
    if results_df is not None:
        ...
        print(f"\n全體數據（排除 '5. 穩定幣'）的 AAR 和 CAAR 結果已儲存至 {AAR_CAAR_XLSX}")
        print(f"全體數據（排除 '5. 穩定幣'）的 3 天檢查結果已儲存至 {CHECK_WINDOW_XLSX}")
