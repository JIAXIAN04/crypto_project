...
# === 1) 讀取幣別資料 ===
df = pd.read_excel(r"C:\Users\Administrator\Desktop\論文\cryptodata\eventday_meme_timeseries.xlsx")
# === 日期往前平移一天，確保是收盤日 ===
...
daily_t_df.to_excel(r"C:\Users\Administrator\Desktop\論文\cryptodata\Daily_AR_ttest_meme.xlsx", index=False)
...
# === 輸出 Excel ===
caar_df.to_excel(r"C:\Users\Administrator\Desktop\論文\cryptodata\CAR_ttest_meme.xlsx", index=False)