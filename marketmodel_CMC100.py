...
daily_t_df.to_excel(r"C:\Users\Administrator\Desktop\論文\cryptodata\Daily_AR_ttest_CMC100-1.xlsx", index=False)
...
# === 輸出 Excel ===
caar_df.to_excel(r"C:\Users\Administrator\Desktop\論文\cryptodata\CAR_ttest_CMC100-1.xlsx", index=False)